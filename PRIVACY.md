...
These justifications explain why each permission is necessary for Pinboard GPT to function.
...
### remote code
**Justification**: Pinboard GPT does not load or execute any remote code. All scripts and resources are bundled with the extension; no external code is fetched or executed at runtime.
...
Pinboard GPT saves and organizes individual ChatGPT messages or entire conversations locally. Use Chat Outline to navigate long conversations instantly. Add custom names and tags, search by text or tags, filter between message and chat pins, and jump directly back to the original conversation. All data stays on your device for complete privacy.
