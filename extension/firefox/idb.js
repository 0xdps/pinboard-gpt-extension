 ...
 * Uses browser.storage.local for free users, browser.storage.sync for Pro/Pro+ users
...
async function getLicense() {
  try {
    const result = await browser.storage.local.get(['license']);
...
async function getStorage() {
  ...
  // Pro and Premium get browser.storage.sync, Free uses browser.storage.local
